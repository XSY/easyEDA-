...
public class FileUtilTest {
	...
	private static void testReadMsgFile() throws IOException {
		...
		FileUtil.readMsgFile(
				"/Users/KennyZJ/router/waiting/e099ce0c-b7c9-4b7c-b4f2-9f733f2730a4.msg",
				msg);
	...
	private static void testMoveDirContent() throws IOException {
		FileUtil.moveDirContent("/Users/KennyZJ/test/src/",
				"/Users/KennyZJ/test/dest/", ".msg");
	}

	private static void testMoveDirToDir() throws IOException {
		FileUtil.moveTo("/Users/KennyZJ/test/src", "/Users/KennyZJ/test/dest");
	}

	private static void testMoveFile() throws IOException {
		FileUtil.moveTo("/Users/KennyZJ/test/src/1", "/Users/KennyZJ/test/dest");
	}

	private static void testIsDirEmpty() throws FileNotFoundException {
		System.out.println(FileUtil.isDirEmpty("/Users/KennyZJ/test", ".msg"));
	}
	...
	private static void testIOwriteAppend() throws IOException {
		...
		for (int i = 0; i < 1000; i++) {
			...
			sb.append("|");
			sb.append("N");
			FileUtil.writeLine(sb.toString().getBytes(), "/Users/KennyZJ/test",
					"workerIO.txt");
			sb.setLength(0);
		}
