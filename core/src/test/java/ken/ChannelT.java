...
public class ChannelT extends Thread {
	public static Logger LOG = Logger.getLogger(ChannelT.class);
	private final static String host = (String) EConfig.loadAll("easyEDA.yaml")
			.get(EConfig.EDA_PIVOT_OUTGOING_HOST);
//	private final static int port = (int) EConfig.loadAll("easyEDA.yaml").get(
//			EConfig.EDA_PIVOT_OUTGOING_PORT);
