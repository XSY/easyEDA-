...
public class EConfig {
	...
	public final static String EDA_FEEDER_DIR_HOME = "eda.feeder.dir.home";
	public final static String EDA_FEEDER_SWAPALL_COUNT = "eda.feeder.swapall.count";
	public final static String EDA_FEEDER_SWAPDONE_COUNT = "eda.feeder.swapdone.count";

	public final static String EDA_PIVOT_DIR_HOME = "eda.pivot.dir.home";
	...
	public final static String EDA_PIVOT_SWAPALL_COUNT = "eda.pivot.swapall.count";
	public final static String EDA_PIVOT_SWAPDONE_COUNT = "eda.pivot.swapdone.count";
	...
	public final static String EDA_ADVANCED_THING_NAME = "eda.advanced.thing.name";
	public final static String EDA_ADVANCED_THING_WORKER ="eda.advanced.thing.worker";
	public final static String EDA_ADV_FOLLOWER_NAME ="";
	public final static String EDA_ADV_FOLLWER_PARALLEL="";
	public final static String EDA_DATA_PRO_RESO_NAME="";
	public final static String EDA_DATA_PRO_RESO_PARALLEL="";
	...
	private static Map findAndReadConfigFile(String name, boolean mustExist) {
		try {
			...
			//how to realize load the configuration file by the upper command??
