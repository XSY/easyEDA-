...
public class AddressingEvtProc extends BaseEvtProc {
	...
	public void prepare(Map stormConf, TopologyContext context,
		...
		//locator = ELocator.getLocator(ELocator.Memcached);
	}
...
//			}
	...
	// ConcurrentHashMap<String, List<Follower>> result = new
	// ConcurrentHashMap<String, List<Follower>>();
