 ...
 * 
 *         The ZContext class wraps java org.zeromq.Context objects, which in
 *         turn wrap native 0MQ contexts. It manages open sockets in the context
 *         and automatically closes these before terminating the context. It
 *         provides a simple way to set the linger timeout on sockets, and
 *         configure contexts for number of I/O threads. Sets-up signal
 *         (interrrupt) handling for the process.
 * 
 */
